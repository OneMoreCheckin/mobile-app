...
/*jshint camelcase:false,quotmark:false,maxlen:210,expr:true,devel:true,maxstatements:90,forin:false,
maxcomplexity:23,maxparams:14,regexp:false,unused:false,newcap: false*/
/*global navigator:true, cordova:true, module:false, require:false*/
;(function() {
  //'use strict';
